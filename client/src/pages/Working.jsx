        ...
        <section className="learn-section">
            ...
            <div className="grid1">
                ...
                <div className="grid-item">
                    ...
                    <img src="/images/person-team.svg" alt="person" />
            ...
            <div className="grid2">
                <div className="grid2-item">
                    <div className="title"><img src="/images/water-droplet.png" alt="drop" /><h5>Save Water</h5></div>
            ...
            <div className="stp-pg">
                ...
                <div className="timeline">
                    <ul>
                        <li>
                            <h4 className="sr">1</h4>
                            <img src="/images/cloudRain.webp" alt="" />
                        ...
                        <li>
                            <h4 className="sr">5</h4>
                            <img src="/images/icn-tip-drop.png" alt="" />
                            <div className="content">
                                <h5>Reuse</h5>
                ...
                <div className="right">
                    ...
                    <div className="box">
                        ...
                        <ul>
                            <li><img src="/images/check.png" alt="" />Conserves freshwater resources</li>
                            <li><img src="/images/check.png" alt="" />Reduces water bills</li>
                            <li><img src="/images/check.png" alt="" />Improves groundwater levels</li>
                            <li><img src="/images/check.png" alt="" />Reduces flooding and soil erosion</li>
                            <li><img src="/images/check.png" alt="" />Supports a sustainable future</li>
                        </ul>
                    </div>
                    <img src="/images/houseImg.png" alt="house" />
                </div>
            </div>
